...
const NameModal: React.FC<ModalProps> = ({
  show,
  onClose,
  children,
  handleModalData,
      ...
      <StyledModal>
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  setHelpModal(true),
                    setHelp(
                      '<span><span style="color: cyan">Enter a human-readable name to identify your key</span></span>'
                    );
                }}
        ...
        <StyledModalBody>
          <input
            ...
            id="keyid"
            key="0"
            placeholder={inputValue || "enter a name"}
            type="text"
            value={inputValue}
            onChange={(e) => {
